...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>学习部主页</title>
	<link rel="stylesheet" type="text/css" href="../css/learnDept/learnDept.css" />
...
<body>
	...
	<div class="main">
		...
		<!-- 侧边栏 -->
		<div class="menu">
				<div><span>&#xf105;</span> 书籍管理</div>
					<ul>
						<li onclick="linkTo(0,this)">借还登记&nbsp;</li>
						<li onclick="linkTo(1,this)">添加书籍&nbsp;</li>
					</ul>
				<div><span>&#xf105;</span> 助教管理</div>
					<ul>
						<li onclick="linkTo(2,this)">查询变更&nbsp;</li>
						<li onclick="linkTo(3,this)">添加助教&nbsp;</li>
					</ul>
	...
	<script src="../js/learnDept/learnDept.js"></script>
</html>