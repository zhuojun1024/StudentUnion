...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>文体部主页</title>
	<link rel="stylesheet" type="text/css" href="../css/styleDept/styleDept.css" />
...
<body>
	...
	<div class="main">
		...
		<!-- 侧边栏 -->
		<div class="menu">
				<div><span>&#xf105;</span> 策划信息</div>
					<ul>
						<li onclick="linkTo(0,this)">新增策划&nbsp;</li>
						<li onclick="linkTo(1,this)">管理策划&nbsp;</li>
					</ul>
	...
	<script src="../js/styleDept/styleDept.js"></script>
</html>